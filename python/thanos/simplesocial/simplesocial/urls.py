...
# path('accounts', include('django.contrib.auth.urls')) this will allow to connect 
# with django underhood auth process
# as we are using django inbuilt models, we don't need to register any of them
